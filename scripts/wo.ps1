...
<#
.SYNOPSIS
  Optimize WSL VHDX Linux files/filesystems and optionally back them up.
...
Write-Output "==================================================================================================================="
Write-Output "[INFO] WSL Disk Optimizer running..." 
Write-Output "==================================================================================================================="

$logFile = "../logs/wo.log"
Start-Transcript -Path $logFile -Append
Write-Output "-------------------------------------------------------------------------------------------------------------------"
Write-Output "[INFO] Scanning known locations for ext4.vhdx files..."
...
Write-Output "[INFO] Found ext4.vhdx files:"
$vhds | ForEach-Object { Write-Output "[$($_.Index)] $($_.FullName) - $($_.SizeGB) GB" }
Write-Output "-------------------------------------------------------------------------------------------------------------------"
$choice = Read-Host "Enter the number of the VHD image you want to optimize"
...
Write-Output "[INFO] Selected VHD image:"
Write-Output "$fullPath"
Write-Output "[INFO] Size before: $($selected.SizeGB) GB"

Write-Output "[INFO] Shutting down WSL..."
wsl --shutdown
...
Write-Output "[INFO] Optimizing with Optimize-VHD..."
...
Write-Output "[INFO] Log saved to: $logFile"
if (-not $noBackup.IsPresent) {
    Write-Output "[INFO] Backup saved to: $backupPath"
}

Write-Output "[INFO] You can now restart WSL using 'wsl'"
Write-Output "-------------------------------------------------------------------------------------------------------------------"
Stop-Transcript
Write-Output "==================================================================================================================="
